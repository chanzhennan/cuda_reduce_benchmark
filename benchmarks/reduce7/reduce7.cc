...
#include "reduce7/reduce7.cuh"


namespace bm = benchmark;

template <typename T>
class Reduce7 : public cudabm::BenchmarkBase {
 public:
  Reduce7() : cudabm::BenchmarkBase(/*numIpus=*/1, /*enableMonitor=*/true) {}
