...
template <typename T>
class Reduce4 : public cudabm::BenchmarkBase {
 public:
  Reduce4() : cudabm::BenchmarkBase(/*numIpus=*/1, /*enableMonitor=*/true) {}
  ...
  void callKernel(size_t data_size) {
    ...
    call_reduce4(d_data, d_res, data_size);
